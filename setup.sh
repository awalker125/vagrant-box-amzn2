...
# This file is modified from the original https://github.com/gebailey/vagrant-boxes/blob/master/amzn2/setup.sh writen by
# Greg Bailey <gbailey@lxpro.com>
# May 3, 2018

# The original licence is copied below.
# Modifications to allow it run via packer.
...
# Install the VirtualBox guest additions pre reqs
